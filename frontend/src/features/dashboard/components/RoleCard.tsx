...
const RoleCard: React.FC<RoleCardProps> = ({
  ...
  // Standardized difficulty color mapping - using yellow for better visibility
  const difficultyColors: Record<string, string> = {
    Easy: "bg-green-100 text-green-700",
    Moderate: "bg-yellow-100 text-yellow-700", // Changed from amber to yellow for better visibility
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-4">
        {/* Header with role title and badges - improved layout */}
